        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tbody>
                ...
                <tr>
                  <td valign="top" align="center"><a href="#"><img alt="Tharbricks" src="{{$image}}" style="padding-bottom: 0; display: inline !important;"></a></td>
                </tr>
                <tr>
                  <td width="100%" height="30">&nbsp;</td>
                </tr>
          ...
          <tr>
            <td class="tablepadding" style="padding:20px 0; border-collapse:collapse">
              ...
              <table width="100%" cellspacing="0" cellpadding="0" border="0" style="font-size:13px;color:#777777; font-family:Arial, Helvetica, sans-serif">
                <tbody>
                  <tr>
                    <td class="tablepadding" align="center" style="line-height:20px; padding-top:10px; padding-bottom:20px;">Copyright &copy; {{date("Y")}} Tharbricks. All Rights Reserved. </td>
                  </tr>
                </tbody>
              </table></td>
          </tr>
