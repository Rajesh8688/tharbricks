                ...
                <div class="col-12 col-lg-4 p-0 wt-dashboard-msg-user-list">
                    ...
                    <div style="position: static;height: 77px;background-color: black;color: white;display: flex;">
                        <div style="padding: 11px 16px;"> 
                            <div>{{$information['totalMyleads']}} {{__('lang.matching_leads')}}</div>
                            <div style="font-size: small;"> {{$information['totalMyservices']}}  {{__('lang.services')}} &nbsp; <span><i class="fa fa-map-marker"></i> &nbsp;1 location</span></div>
                        </div>
                    ...
                    <div id="msg-list-wrap" class="wt-dashboard-msg-search-list">
                        ...
                        <div class="wt-dashboard-msg-search-list-wrap" >
                            <a href="javascript:;" class="msg-user-info clearfix" style="padding: 15px 10px 15px 20px ">
                                <div class="msg-user-info-text">
                                    <div><div class="msg-user-name"><b>{{__('lang.no_pending_leads')}}</b></div> 
                                ...
                                <div class="container">
                                    <div class="sf-provi-bio-box cleafix margin-b-50 ">
                                        ...
                                        @if($lead->reviewLink != "dontShow")
                                            ...
                                            <div class="sf-provi-cat"> <i class="aon-input-icon fa fa-star"></i> &nbsp; {{__('lang.rating')}} :
                                            ...
                                            @else
                                            <div class="sf-provi-cat"> <i class="aon-input-icon fa fa-star"></i> &nbsp; {{__('lang.request_review')}} : 
                                                @if($lead->reviewLink == "send")
                                                <a onclick="requestReview({{$lead->id}})" > {{__('lang.send_review_link')}}</a>
                                                @elseif($lead->reviewLink == "resend")
                                                <a  onclick="requestReview({{$lead->id}})" > {{__('lang.resend_review_link')}}</a>
                                                @endif
                                            </div>
                                            @endif
                                        @endif
