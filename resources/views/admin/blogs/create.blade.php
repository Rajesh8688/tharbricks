                ...
                <section class="invoice-print mb-1">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-7 d-flex flex-column flex-md-row justify-content-end">
                            @can('blogs-view')
                            <a href="{{route('blogs.index')}}" class="btn btn-primary btn-print mb-1 mb-md-0"><i
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class= "col-md-6 col-12">
                                                        ...
                                                        <div class="form-label-group">
                                                            <input type="text" id="tags" class="form-control " placeholder="Tags" name="tags" value="{{old('tags')}}" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <label for="first-name-column">User Name</label>
                                                        <div class="form-label-group">
                                                            <input type="text" id="user_name" class="form-control @error('user_name') is-invalid @enderror" placeholder="User Name" name="user_name" value="{{old('user_name')}}" autocomplete="off" required>
                                                            @error('user_name')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea  id="ckeditor" class="form-control @error('description') is-invalid @enderror" rows="5" placeholder="Description" name="description" required>{{old('description')}}</textarea>
                                                            @error('description')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
