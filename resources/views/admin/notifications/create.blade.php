                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="Name" name="title" value="{{old('title')}}" autocomplete="off" required>
                                                            @error('title')
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea   class="form-control @error('message') is-invalid @enderror" rows="5" placeholder="Description" name="message" required>{{old('message')}}</textarea>
                                                            @error('message')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
