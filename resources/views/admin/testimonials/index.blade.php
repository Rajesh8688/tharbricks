                ...
                <section class="invoice-print mb-1">
                    <div class="row">
                        <div class="col-12 col-md-12 d-flex flex-column flex-md-row justify-content-end">
                            <a href="{{route('testimonials.create')}}" class="btn btn-primary btn-print mb-1 mb-md-0"><i
                                    class="feather icon-plus-circle"></i>&nbsp;Add Testimonials</a>
                            </a>
                        </div>
                    </div>
                </section>
                                                    ...
                                                    @foreach($testimonials as $testimonial)
                                                        <tr>
                                                            ...
                                                            <td class="product-img">
                                                                <img
                                                                    src="{{$testimonial->image ?  asset('uploads/testimonials/'.$testimonial->image) : $noImage}} "
                                                                    width="44"/>
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @can('testimonials-delete')
                                                                    <a href="javascript:" class="text-danger deleteBtn"
                                                                       onclick="destroy({{$testimonial->id}})"
...
@section('extrascript')
    <script>
        ...
        function destroy(delId) {
            let url = '{{ route("testimonials.destroy", ":id") }}';
