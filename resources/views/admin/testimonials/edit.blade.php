                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{route('testimonials.update', $testimonial->id)}}"
                                              method="post"
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="form-label-group">
                                                            ...
                                                            <input type="text" id="name" class="form-control"
                                                                   placeholder="Name"
                                                                   name="name"
                                                                   value="{{$testimonial->name}}" autocomplete="off">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <select name="service_id" class="form-control @error('service_id') is-invalid @enderror" required>
                                                            ...
                                                            <option value = "{{$service->id}}" {{$testimonial->service_id == $service->id ? 'selected' : ''}}>{{$service->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('service_id')
                                                            <span class="invalid-feedback" role="alert">
                                                    ...
                                                    <div class="row">
                                                        <div class= "col-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea  class="form-control @error('description') is-invalid @enderror" rows="5" placeholder="Description" name="description" required>{{$testimonial->description}}</textarea>
                                                                @error('description')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
